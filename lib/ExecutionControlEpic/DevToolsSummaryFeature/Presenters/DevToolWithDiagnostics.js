...
function getSingleCircleStyles(props: CircleProps) {
  return [
    css`
...
function getDoubleCircleStyles(props: CircleProps) {
  return [
    css`
      top: -${props.circleSize}px;
      left: ${getEntityWidth() / 2 - props.circleSize - 2}px;
...
function getTripleCirclesStyles(props: CircleProps) {
  return [
    css`
      top: -${props.circleSize}px;
...
function getFourCirclesStyles(props: CircleProps) {
  return [
    css`
      top: -${props.circleSize - 10}px;
...
function getStylesForCircles(props: CircleProps) {
...
type CircleProps = Props & { hovered: boolean };
